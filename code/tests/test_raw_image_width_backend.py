...
class RawWidthBackendTests(unittest.TestCase):
    ...
    def test_propagated_width_is_displayed_but_not_change_evidence(self):
        ...
        self.assertEqual(segments.quality_grade.tolist(),['A','B','C'])
        self.assertEqual(corridors.width_source.tolist(),['measured','interpolated','propagated'])
        ...
        self.assertEqual(_reliable_width_at(scene,np.array([Point(2,0),Point(25,0),Point(55,0)],object)).tolist(),[True,True,False])
