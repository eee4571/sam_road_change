...
主页只显示“项目 / 处理 / 成果”。主按钮根据状态显示“配置数据、修正数据、开始处理、继续处理、继续更新或查看成果”；运行中显示进度与取消。完整重算、更新部分成果、重新扫描、重新检查和环境检查位于“…”菜单。

“更新部分成果”选择一个区域的期次或变化对，显示与实际更新共用的影响范围，再点击“开始更新”。独立成果页按区域和业务类别展开文件，每个“打开”仅通过原 `result_ready` 信号报告一个路径。顶部“日志”只显示当前日志与最近错误。
